...
Topic:   subscribes to ultrasonic topic (sensor_msgs/Range)
...
class UltrasonicExample(Node):
    def __init__(self):
        ...
        self.sub = self.create_subscription(Range, 'ultrasonic_range1', self.on_range, 10)
        self.get_logger().info('Listening on ultrasonic_range1 topic...')
